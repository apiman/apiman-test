...
public class HttpSecurityPlanPolicyIT extends AbstractHttpSecurityPolicyIT{
    ...
    @Client(organization = "organization")
    @ClientVersion(contracts = {@Contract(vPlan = "configPlan", vApi = "configEndpoint")})
    private static ClientVersionBean configClientVersion;

    @ApiKey(vPlan = "configPlan", vApi = "configEndpoint", vClient = "configClientVersion")
