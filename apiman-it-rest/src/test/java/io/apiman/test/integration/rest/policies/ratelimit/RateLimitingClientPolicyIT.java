...
public class RateLimitingClientPolicyIT extends AbstractRateLimitingPolicyIT {
    ...
    @ClientVersion(policies = @Policies("rate_001"), contracts = @Contract(vPlan = "plan", vApi = "endpoint"))
