 ...
 * @author jkaspar
 */
public abstract class AbstractTransferQuotaCombinedPolicyIT extends AbstractTransferQuotaPolicyIT {
    ...
    @Test
    public void uploadUseUpQuota() {
        uploadNBytes(1);
        assertRemaining(LIMIT - 1);
    }

    @Test
    public void downloadUseUpQuota() {
        downloadNBytes(1);
        assertRemaining(LIMIT - 1);
    }
}
