...
public class TransferQuotaCombinedClientPolicyIT extends AbstractTransferQuotaCombinedPolicyIT {
    ...
    @ClientVersion(contracts = @Contract(vApi = "endpoint", vPlan = "plan"),
        policies = @Policies(value = "transfer_001", params = {"direction", "both"}))
