...
public class TransferQuotaDownloadPlanPolicyIT extends AbstractTransferQuotaDownloadPolicyIT {
    ...
    @PlanVersion(policies = @Policies(value = "transfer_001", params = {"direction", "download"}))
