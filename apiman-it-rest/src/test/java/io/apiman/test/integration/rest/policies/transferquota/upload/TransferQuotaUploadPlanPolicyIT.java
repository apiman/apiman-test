...
public class TransferQuotaUploadPlanPolicyIT extends AbstractTransferQuotaUploadPolicyIT {
    ...
    @PlanVersion(policies = @Policies(value = "transfer_001", params = {"direction", "upload"}))
