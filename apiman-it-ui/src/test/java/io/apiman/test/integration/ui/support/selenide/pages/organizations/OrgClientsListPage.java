 ...
 * @author jkaspar
 */
@PageLocation("/apimanui/api-manager/orgs/{0}/clients")
public class OrgClientsListPage extends OrgEntitiesListPage<OrgClientsListPage> {

    /**
     * New Client button
     * @return element
     */
    public SelenideElement newClientButton() {
        return $("a[data-field='toNewClient']");
    }

    /**
     * Click to New Client button
     * @return CreateClientPage
     */
    public CreateClientPage newClient() {
