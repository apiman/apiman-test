...
package io.apiman.test.integration.ui.support.selenide.pages.users;
 ...
 * @author jcechace
 */
@PageLocation("/apimanui/api-manager/users/{0}/orgs")
public class UserOrgsListPage extends OrgEntitiesListPage<UserOrgsListPage> {
    ...
    /**
     * Click to New Org button
     * @return CreateOrgPage
     */
    public CreateOrgPage newOrg() {
        newOrgButton().click();
