...
import io.apiman.test.integration.ui.support.selenide.pages.policies.AddLdapBASICAuthenticationPolicyPage;
 ...
 * @author jkaspar
 */
public class LdapBASICAuthenticationPolicyIT extends AbstractApiPolicyIT {

    private AddLdapBASICAuthenticationPolicyPage addPolicyPage;

    @Before
    public void openPage() {
        addPolicyPage = policiesDetailPage.addPolicy(AddLdapBASICAuthenticationPolicyPage.class);
        addPolicyPage
            .authenticationRealm("foo")
            .serverUrl("ldap://foo.com")
            .bindDN("bar");
    }
