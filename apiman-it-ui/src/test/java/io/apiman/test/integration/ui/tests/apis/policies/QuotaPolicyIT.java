...
import io.apiman.test.integration.ui.support.selenide.pages.policies.AddQuotaPolicyPage;
 ...
 * @author jkaspar
 */
public class QuotaPolicyIT extends AbstractApiPolicyIT {

    private AddQuotaPolicyPage addPolicyPage;

    @Before
    public void openPage() {
        addPolicyPage = policiesDetailPage.addPolicy(AddQuotaPolicyPage.class);
    }

    @Override
    protected String getDefinitionId() {
        return PolicyDefs.QUOTA_POLICY;
    }

    @Test
    public void canAddPolicy() {
        addPolicyPage
            .configure(10, "Client App", "Day")
