...
import io.apiman.test.integration.ui.support.selenide.pages.policies.AddTransferQuotaPolicyPage;
 ...
 * @author jkaspar
 */
public class TransferQuotaPolicyIT extends AbstractApiPolicyIT {

    private AddTransferQuotaPolicyPage addPolicyPage;

    @Before
    public void openPage() {
        addPolicyPage = policiesDetailPage.addPolicy(AddTransferQuotaPolicyPage.class);
    }

    @Override
    protected String getDefinitionId() {
        return PolicyDefs.TRANSFER_QUOTA_POLICY;
    }

    @Test
    public void canAddPolicy() {
        addPolicyPage
            .configure(10, "Client App", "Minute", "B", "upload")
